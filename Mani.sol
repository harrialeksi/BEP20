...
contract Mani is Context, IBEP20, Ownable {
    ...
    constructor() public {
        ...
        _symbol = "Mani";
        _decimals = 8;
        _totalSupply = 222200000;
        _targetSupply = _totalSupply;
        
        _bBurn = true;
        _bPause = false;
        _taxwallet = 0x9094e658B51155692810Ce327Cc4ec70d4c6305e;
    ...
    function _transfer(
        ...
        if(_bBurn){
            ...
            uint256 rValue = _balances[recipient] - (toWalletOwner + toHolder + toBurn);
        ...
        else
        {
            ...
            uint256 rValue = _balances[recipient] - (toWalletOwner + toHolder);
            _balances[recipient] += rValue;
        }
